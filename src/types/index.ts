...
export interface ReportSession { id: string; createdAt: number; updatedAt: number; childNameLabel?: string; sourceFileName?: string; reportDate?: string; batchId?: string; batchIndex?: number; batchTotal?: number; status: "in_progress" | "completed" | "error"; rawInput: string; priorityDomains?: string[]; lastCompletedStep: WorkflowStep; stepOutputs: Omit<WorkflowCheckpoint, "lastCompletedStep">; stepTraceLog: { text: string; phase: string }[]; messages: ChatMessage[]; lastError?: string; }
